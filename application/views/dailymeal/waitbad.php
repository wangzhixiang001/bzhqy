...
<div class="container js_container">
    <div class="page"><br>
    <div class="weui_msg">
        <div class="weui_icon_area"><img style="border-style: solid;border-width:5px;border-color: transparent;width:60%;" src="style/dailymeal/img/foodno.jpg"></div>
            <div class="weui_text_area">
                <h2 class="weui_msg_title">报饭已截止，你没赶上报饭耶</h2>
                <p class="weui_msg_desc">今天是<?php echo date('Y年m月d日');?> 星期<?php $arr = array('日','一','二','三','四','五','六');echo $arr[date('w')];?></p>
                <p class="weui_msg_desc">您错过饭点了，如果你需要报饭，下次记得在9:30前报哦。</p>
            </div>
