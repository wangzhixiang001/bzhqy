...
<div class="container js_container">
    ...
    <div class="weui_msg" style="padding-top:8%;">
        <div class="weui_icon_area" style="margin-bottom:5%;"><img style="border-style: solid;border-width:5px;border-color: transparent;width:50%;" src="style/dailymeal/img/foodyes.jpg"></div>
            <div class="weui_text_area">
                <h2 class="weui_msg_title">您已经报饭成功！</h2>
                <p class="weui_msg_desc">今天是<?php echo date('Y年m月d日');?> 星期<?php $arr = array('日','一','二','三','四','五','六');echo $arr[date('w')];?></p>
                <p class="weui_msg_desc">可取消剩余时间:<span id="htime">--小时--分钟--秒</span></p>
            </div>
            <div class="weui_opr_area">
                <p class="weui_btn_area">
                    <a id="bfbtn" href="javascript:weDialog.show();" class="weui_btn weui_btn_warn">取消报饭</a>
<?php if($cantp<3&&time()<=strtotime(date('Y-m-d 10:00'))){ ?><a id="txdj" href="javascript:tixing.show();" class="weui_btn" style="background-color:#00B0FF;">提醒大家~</a><?php } ?>
...
<div class="weui_dialog_confirm antFade" id="dialog2" style="display:none;">
    ...
    <div class="weui_dialog">
        <div class="weui_dialog_hd"><strong class="weui_dialog_title">提醒</strong></div>
        <div class="weui_dialog_bd">您确定要取消报饭吗？</div>
        <div class="weui_dialog_ft">
            <a href="javascript:$('#dialog2').hide();" class="weui_btn_dialog default">取消</a>
            <a href="javascript:weDialog.close();" class="weui_btn_dialog primary">确定</a>
        </div>
    </div>
</div>
...
<div class="page slideIn">
    <div class="weui_msg">
        ...
        <div class="weui_text_area">
            <h2 class="weui_msg_title">取消成功</h2>
            <p class="weui_msg_desc">报饭截止(9:30)前您可以再次报饭。</p>
        </div>
        <div class="weui_opr_area">
            <p class="weui_btn_area">
...
function bao(){
	$('#loadingToast').show();
	$.get('<?php echo base_url();?>index.php/dailymeal/user/bf_ajax/0',
		function(data){
			if(data==1){
				$('#loadingToast').hide();
...
var timelost={
	time:<?php echo strtotime(date('Y-m-d').' 10:30:00')-time();?>,
