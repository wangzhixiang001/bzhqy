...
var table = $('.table-sort').DataTable({
    ...
    "bAutoWidth": false,
    "ajax": {
        "url": "<?php echo base_url();?>index.php/dailymeal/admin/ajaxuserlist",
        "type": "POST",
        "data": function ( d ) {
            d.begin = begin;
            d.end = end;
...
function outexcel(){
	window.location.href="<?php echo base_url();?>index.php/dailymeal/admin/outnum?begin="+begin+"&end="+end;
}
</script> 
</body>
</html>